...
A/B Test Analysis
$
npx skills add https://github.com/aj-geddes/useful-ai-prompts --skill 'A/B Test Analysis'
SKILL.md
A/B Test Analysis
Overview
...
Sample Size
: Observations needed for power
Significance Level
: Type I error threshold (α = 0.05)
Power
: 1 - Type II error (typically 0.80)
Analysis Steps
...
print
(
f"Probability Treatment > Control:
{
prob_treatment_better
:
.4f
