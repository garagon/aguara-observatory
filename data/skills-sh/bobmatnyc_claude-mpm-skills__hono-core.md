...
:
Hono
: Multi-runtime, Web Standards, ultrafast, edge-optimized
Express
: Node.js only, larger ecosystem, slower
Fastify
: Node.js only, schema-based, good performance
Elysia
: Bun only, excellent performance, different API style
Core Concepts
