...
;
Important
: The last owner cannot be removed. Assign the owner role to another member first.
...
<a href="https://yourapp.com/accept-invite?id=
${
invitation
.
id
...
;
Note
: For dynamic access control, the client side role permission check will not work. Please use the
hasPermission
endpoint.
Teams
