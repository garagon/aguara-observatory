...
📋
Table-Driven Tests
: Idiomatic pattern for testing multiple inputs
✅
Testify
: Readable assertions and test suites
🎭
Gomock
...
🔍
Race Detector
: Concurrent code safety verification
📊
Coverage
: Native coverage reporting and enforcement
🚀
CI Integration
...
Errorf
(
"ValidateUser() error = %v, wantErr %v"
,
err
,
tt
...
Errorf
(
"ValidateUser() error message = %v, want %v"
,
err
.
Error
...
func
TestUserService_CreateUser_Validation
(
t
*
testing
...
|
awk
'{if (substr($3, 1, length($3)-1) < 80) exit 1}'
Decision Trees
...
for concurrent code
Enforce Coverage
: Set minimum thresholds in CI (typically 80%)
Use Golden Files
: Test complex outputs with expected files
Keep Tests Fast
: Mock slow operations, use
-short
flag for quick runs
Resources
...
Google Go Style Guide - Testing:
https://google.github.io/styleguide/go/
Related Skills:
golang-engineer
: Core Go patterns and concurrency
...
# HTML report
Token Estimate
: ~4,500 tokens (entry point + full content)
Version
: 1.0.0
Last Updated
: 2025-12-03
