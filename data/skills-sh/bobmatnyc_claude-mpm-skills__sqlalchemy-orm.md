...
# Get updated fields (id, timestamps)
return
user
# Bulk insert
users
...
django
: Django ORM patterns and migration strategies for comparison
test-driven-development
: TDD patterns for database models and queries
fastapi-local-dev
: FastAPI + SQLAlchemy integration patterns
systematic-debugging
: Advanced debugging for ORM query issues and N+1 problems
