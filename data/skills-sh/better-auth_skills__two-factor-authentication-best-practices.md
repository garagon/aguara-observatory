...
"My App"
,
// Used as the default issuer for TOTP
plugins
:
[
twoFactor
...
"My App"
,
// Optional: override the app name for 2FA specifically
}
)
,
]
...
"/2fa"
;
// Redirect to your 2FA verification page
}
,
}
)
...
;
Note
: This is generally not recommended as it doesn't confirm the user has successfully set up their authenticator app.
...
6
,
// 6 or 8 digits (default: 6)
period
:
30
,
// Code validity period in seconds (default: 30)
}
,
}
)
...
5
,
// Code validity in minutes (default: 3)
digits
:
6
,
...
5
,
// Max verification attempts (default: 5)
}
,
}
)
...
"encrypted"
,
// Options: "plain", "encrypted", "hashed"
}
,
}
)
...
;
Note
: Each backup code can only be used once and is removed from the database after successful verification.
...
10
,
// Length of each code (default: 10)
storeBackupCodes
:
"encrypted"
,
// Options: "plain", "encrypted"
}
,
}
)
...
;
Note
: The trust period refreshes on each successful sign-in within the trust window.
...
5
,
// Max attempts per OTP code (default: 5)
}
,
}
)
...
;
Note
: When 2FA is disabled, trusted device records are revoked.
