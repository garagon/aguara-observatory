...
usersv1
"example.com/myapp/gen/users/v1"
)
type
Service
struct
...
Use
unary
for single request/response and simple retries.
Use
server streaming
for large result sets or continuous updates.
Use
client streaming
for bulk uploads with one final response.
Use
...
Anti-Patterns
Ignore deadlines
: unbounded handlers cause tail latency and resource exhaustion.
...
Send
errors.
Expose reflection in production
: treat reflection as a discovery surface.
Troubleshooting
Symptom: clients see
UNKNOWN
errors
